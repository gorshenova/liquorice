...
/**
 * LiquoriceHidingUtils is a simple utility to manage the XOR hiding routines.
 */
public class LiquoriceHidingUtils {
    private static Logger logger = Logger.getLogger(LiquoriceHidingUtils.class);
