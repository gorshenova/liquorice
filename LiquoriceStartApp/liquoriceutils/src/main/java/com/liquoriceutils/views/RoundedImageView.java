...
public class RoundedImageView extends ImageView {
    ...
    private boolean mutateBackground = true;
    ...
    private ScaleType scaleType = ScaleType.MATRIX;
...
//        }
    ...
    private Drawable resolveResource() {
        ...
        if (mResource != 0) {
            try {
                ...
                Log.w(TAG, "Unable to findByDto resource: " + mResource, e);
                // Don't try again.
                mResource = 0;
            }
        }
    ...
    public boolean isNeedRound() {
        return isOval() || getCornerRadius()>0;
    }
}
