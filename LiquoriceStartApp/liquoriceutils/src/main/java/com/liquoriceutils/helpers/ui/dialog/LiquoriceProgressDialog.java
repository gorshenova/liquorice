 ...
 * To modify a background color, add it in bundle arguments with the parameter name 'ProgressBackgroundColor',
 * use constants LiquoriceProgressDialog.PROGRESS_BACKGROUND_COLOR
 */
public class LiquoriceProgressDialog extends ProgressDialog {

    public static final String PROGRESS_BACKGROUND_COLOR = "ProgressBackgroundColor";
    private int bgColor;

    public LiquoriceProgressDialog(Context context) {
        super(context, R.style.Liquorice_Theme_Dialog);
    }
